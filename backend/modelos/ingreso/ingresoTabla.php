...
// Clase encargada de crear la tabla ingresos en la base de datos
class IngresoCrearTabla
{
  ...
  // Crea la tabla ingresos si no existe
  public function crearTablaIngreso()
  {
